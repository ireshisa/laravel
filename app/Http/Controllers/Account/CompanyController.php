...
class CompanyController extends AccountBaseController
{
	...
	public function create()
	{
		...
		return view('account.company.create')->with('cats', $cats)->with('admin_divs',$admin_divs)->with('teamsize', $data['teamsize']);
	}
...
// 		return redirect(config('app.locale') . '/account/companies/' . $id . '/edit');
	...
	//	dd($admin_divs);
		...
		return view('account.company.edit')->with('company', $company)->with('admin_divs',$admin_divs)->with('cats', $cats)->with('teamsize', $data['teamsize']);
	}
