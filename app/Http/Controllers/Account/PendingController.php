...
class PendingController extends AccountBaseController
{
	private $perPage = 10;
	...
	public function index()
	{
		...
		// Set the Page Path
		view()->share('pagePath', 'pending-approval');
		
		// Get the Conversations
		$data['conversations'] = $this->pendingPosts->whereIn('delete_request', ['0'])->paginate($this->perPage);
	    // dd($data);	
		// Meta Tags
		...
		return view('account.pending', $data);
	}
