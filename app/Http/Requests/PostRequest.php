...
class PostRequest extends Request
{
	...
	public function rules()
	{
		...
		//	'job_description'    => ['required', new BetweenRule(5, 12000), new BlacklistWordRule()],
		...
		if (!$this->filled('company_id') || empty($this->input('company_id'))) {
			$rules['name'] = ['required', new BetweenRule(2, 200), new BlacklistTitleRule()];
			$rules['description'] = ['required', new BetweenRule(5, 1000), new BlacklistWordRule()];
