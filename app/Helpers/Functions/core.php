...
function replaceCoverLetter($coverLetter,$replacement) {
    $find =  ["*CurrentDate*","*ToWhom*","*Employer/Company*","*Address*","*Address2*"];
    return str_ireplace($find,$replacement,$coverLetter);
}
...
function genEmailContactBtn($post = null, $btnBlock = false)
{
	...
	$btnLink = '#applyJob';
	return  '<button type="submit" class="btn btn-default" >'.'<i class="icon-mail-2"></i> '.t('Apply Online').'</button>';
//    return $btnLink;
//	$btnAttr = 'data-toggle="modal"';
    ...
    {
        $out .= '<a class="btn btn-default not-register"><i class="icon-mail-2"></i>'.t('Apply Online').'</a>';
