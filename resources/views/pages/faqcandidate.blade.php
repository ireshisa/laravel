...
<div class="container body-content">
    <div class="row">
            ...
            <div class="d-flex flex-wrap justify-content-center card-container-home">
                <div class="card rounded mx-4 my-5 d-inline-block">
                    ...
                    <div class="card-body text-center">
                        <h4 class="card-title">Application Made Easy</h4>
                        <p>
                ...
                <div class="card rounded mx-4 my-5 d-inline-block">
                    ...
                    <div class="card-body text-center">
                        <h4 class="card-title">High Employment Probability</h4>
                        <p>
                ...
                <div class="card rounded mx-4 my-5 d-inline-block">
                    ...
                    <div class="card-body text-center">
                        <h4 class="card-title">Get Highlighted</h4>
                        <p>
                ...
                <div class="card rounded mx-4 my-5 d-inline-block">
                    ...
                    <div class="card-body text-center">
                        <h4 class="card-title">Create Alerts</h4>
                        <p class="px-3 pb-4">
        ...
        <div class="col-md-12 grey-background my-2">
            ...
            {{--                </div>--}}
            {{--            </div>--}}
            <h1 class="mt-3">For Employees</h1>
            <div class="col-md-12">
        ...
        @if(!auth()->check())
            <div class="col-md-12 mt-5 text-center">
                ...
                <a data-toggle="modal" href="#quickRegister" class="btn btn-primary btn-lg text-center text-lg-center" style="font-size: 1.3rem; font-weight: 600;">Get Hired NOW!</a>
            </div>
        @endif
    </div>
</div>
