			...
			<ul class="sidebar-menu">
				...
				<li class="treeview">
					...
					<ul class="treeview-menu">
						@if (auth()->user()->can('list-post') || auth()->user()->can('list-permission'))
						<li>
				...
				@if (auth()->user()->can('list-payment') || auth()->user()->can('list-permission'))
				<li><a href="{{ admin_url('payments') }}"><i class="fa fa-usd"></i> <span>{{ trans('admin::messages.payments') }}</span></a></li>
				@endif
				@if (auth()->user()->can('list-page') || auth()->user()->can('list-permission'))
				<li><a href="{{ admin_url('pages') }}"><i class="fa fa-clone"></i> <span>{{ trans('admin::messages.pages') }}</span></a></li>
				@endif
				@if (auth()->user()->can('list-permission') || userHasSuperAdminPermissions() ||auth()->user()->can('list-interviews') )
					<li><a href="{{ admin_url('interviews') }}"><i class="fa fa-group"></i> <span>Interviews</span></a></li>
				@endif
				@if (auth()->user()->can('list-permission'))
					<li><a href="{{ admin_url('report') }}"><i class="fa fa-file"></i> <span>Report - No Show</span></a></li>
				@endif
				@if (auth()->user()->can('list-permission'))
					<li><a href="{{ admin_url('report-review') }}"><i class="fa fa-star"></i> <span>Report - Review</span></a></li>
				@endif
				@if (auth()->user()->can('list-permission'))
					<li><a href="{{ admin_url('testimonials') }}"><i class="fa fa-clone"></i> <span>Testimonials</span></a></li>
				@endif
				{!! $pluginsMenu !!}
				...
				@if (app()->isDownForMaintenance())
					@if (auth()->user()->can('maintenance-up') || auth()->user()->can('list-permission'))
					<li>
					...
					@endif
				@else
					@if (auth()->user()->can('maintenance-down') || auth()->user()->can('list-permission'))
					<li>
