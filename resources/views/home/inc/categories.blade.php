@if (isset($categoriesOptions) and isset($categoriesOptions['type_of_display']))<!--type_of_display-->
	@include('home.inc.spacer')
	<div class="container">
		<div class="col-xl-12 content-box layout-section border border-info">
			<div class="row row-featured row-featured-category">
				<div class="col-xl-12 box-title no-border">
					<div class="inner">
						<h2>
							<span class="title-3" style="color: #16a085">{{ t('Browse by') }} <span style="font-weight: bold; color: #16a085">{{ t('Category') }}</span></span>
