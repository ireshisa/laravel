...
@if (isset($sForm['enableFormAreaCustomization']) and $sForm['enableFormAreaCustomization'] == '1')
	...
	<div class="wide-intro {{ $parallax }}"  style="height:300px;">
		<div class="dtable hw100">
			<div class="dtable-cell hw100">
				<div class="container text-center">
					
					@if ($sForm['hideTitles'] != '1')
						<p class="intro-title animated fadeInDown " style="text-transform: capitalize; color:#03989e; font-size: 1.7rem;"> {{ $sForm['title'] }} </p>
						<p class="sub animateme fittext3 animated fadeIn d-none d-sm-block">
							{!! $sForm['subTitle'] !!}
						</p>
					@endif
					
					@if ($sForm['hideForm'] != '1')
						<div style="width:60%; padding-right:1rem" class="search-row animated fadeInUp" >
								...
								<div class="row m-0">
									...
									<div class="col-sm-2 col-xs-12 search-col">
										<button class="btn btn-primary btn-search btn-block">
											<i class="icon-search" style="color: #fff;"></i> <strong style="color: #fff;">{{ t('Find') }}</strong>
										</button>
									</div>
									{!! csrf_field() !!}
								</div>
						...
						<div class="search-row fadeInUp">
							...
							<form id="search" name="search" action="{{ lurl(trans('routes.v-search', $attr), $attr) }}" method="GET">
								<div class="row m-0">
									...
									<div class="col-sm-2 col-xs-12 search-col">
										<button class="btn btn-primary btn-search btn-block">
											<i class="icon-search" style="color: #fff;"></i> <strong style="color: #fff;">{{ t('Find1') }}</strong>
										</button>
									</div><br>
									{!! csrf_field() !!}
								</div>
