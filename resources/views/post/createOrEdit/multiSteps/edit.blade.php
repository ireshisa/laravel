							...
							<div class="col-sm-12">
								<form class="form-horizontal" id="postForm" method="POST" action="{{ url()->current() }}" enctype="multipart/form-data">
									...
									<fieldset>
													...
													@foreach ($genders as $gender)
														<div class="form-check form-check-inline pt-2">
															<input name="gender_id"
																   ...
																   type="radio" {{ $post->gender_id ==$gender->tid ? 'checked="true"' : '' }}/>
										...
										<div class="form-group row required">
											<label class="col-md-3 col-form-label" for="title">{{ ('Experience') }}</label>
											<div class="col-md-8">
												<select name="experience" id="experience" class="form-control {{ $experienceError }}" >
													<option value=""></option>
													<option value="6 months" {{old('experience') == '6 months' ? 'selected' : (isset($post->experience) ? 'selected' : '')}}>6 Months</option>
													<option value="1 years" {{old('experience') == '1 years' ? 'selected' : (isset($post->experience) ? 'selected' : '')}}>1 Year</option>
													<option value="2 years" {{old('experience') == '2 years' ? 'selected' : (isset($post->experience) ? 'selected' : '')}}>2 Years</option>
													<option value="3 years" {{old('experience') == '3 years' ? 'selected' : (isset($post->experience) ? 'selected' : '')}}>3 Years</option>
													<option value="4 years" {{old('experience') == '4 years' ? 'selected' : (isset($post->experience) ? 'selected' : '')}}>4 Years</option>
													<option value="5 years" {{old('experience') == '5 yeas' ? 'selected' : (isset($post->experience) ? 'selected' : '')}}>5 Years</option>
													<option value="more than 5 years" {{old('experience') == 'more than 5 years' ? 'selected' : (isset($post->experience) ? 'selected' : '')}}>More than 5 Years</option>
												</select>
											</div>
										</div>

										<!-- qualification-->
										<?php $qualificationError = (isset($errors) and $errors->has('qualification')) ? ' is-invalid' : ''; ?>
										<div class="form-group row required">
											<label class="col-md-3 col-form-label" for="title">{{ ('Qualification') }} <sup>*</sup></label>
											<div class="col-md-8">
												<select name="qualification" id="" class="form-control{{ $qualificationError }}">
													<option value=""></option>
													<option value="Certificate" {{old('qualification') == 'Certificate' ? 'selected' : (isset($post->qualification) ? 'selected' : '')}}>Certificate</option>
													<option value="Bachelors" {{old('qualification') == 'Bachelors' ? 'selected' : (isset($post->qualification) ? 'selected' : '')}}>Bachelors</option>
													<option value="Masters" {{old('qualification') == 'Masters' ? 'selected' : (isset($post->qualification) ? 'selected' : '')}}>Masters</option>
													<option value="Phd" {{old('qualification') == 'Phd' ? 'selected' : (isset($post->qualification) ? 'selected' : '')}}>Phd</option>
												</select>
											</div>
										</div>
										...
										<!-- Company deadline -->
										<?php $deadlineError = (isset($errors) and $errors->has('company.deadline')) ? ' is-invalid' : ''; ?>
										<div class="form-group row">
											<label class="col-md-3 col-form-label" for="post.phone">{{ ('Deadline') }}<sup>*</sup></label>
											<div class="col-md-8">
												<input name="deadline" type="date"
													   class="form-control{{ $deadlineError }}" placeholder=""
													   value="{{ old('deadline', (isset($post->deadline) ? $post->deadline : '')) }}">
											</div>
										</div>
...
{{--										<div class="form-group row">--}}
{{--											<label class="col-md-3 col-form-label" for="tags">Position Filled? </label>--}}
{{--											<div class="col-md-8 d-flex align-items-center">--}}
{{--												<input--}}
{{--													   name="position_filled"--}}
{{--													   placeholder="Position Filled?"--}}

{{--													   type="checkbox"--}}
{{--													   value="1"--}}
{{--													   {{(($post->is_filled == 1)?"checked":'')}}--}}
{{--												>--}}
{{--											</div>--}}
{{--										</div>--}}
