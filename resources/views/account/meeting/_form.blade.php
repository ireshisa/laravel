...
{{--                @endforeach--}}
    ...
    <div class="form-group row required">
        ...
        <div class="{{ $classRightCol }}">
            <div class="row form-group">
                <div class="col-md-4">
                    Date: <input type="text" id="datepicker" name="date" class="form-control required"/>
                </div>
                <div class="col-md-4">
                    From: <input type="time" id="m_from" name="m_from" class="form-control required"/>
                </div>
                <div class="col-md-4">
                    To: <input type="time" id="m_to" name="m_to" class="form-control required"/>
                </div>        
            </div>                
        </div>
    </div>
    ...
    <div class="form-check"  style="">
        <center>    <input type="checkbox" class="form-check-input" id="exampleCheck1" onclick="showmassagebox()">
    <label class="form-check-label" for="exampleCheck1">send additional message</label></center>
...
<br>
    ...
    <div class="form-group row required" id="myDIV">
