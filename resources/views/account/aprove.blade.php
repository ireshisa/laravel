		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-9 page-content">
					<div class="inner-box">
						<h2 class="title-2">
							<i class="icon-mail"></i> {{ ('Applicants') }}
						</h2>
							...
							<form name="listForm" method="POST" action="{{ lurl('account/'.$pagePath.'/delete') }}">
								...
								<table id="addManageTable" class="table table-striped table-bordered add-manage-table table demo" data-filter="#filter" data-filter-text-only="true">
									...
									<tr>
										...
										<th style="width:88%" data-sort-ignore="true">{{ ('Applicants') }}</th>
									...
									<tr>
										...
										<td class="action-td">
											<div>
												<p>
													<a class="btn btn-default btn-sm" style="width: 4rem;" href="{{ lurl('account/conversations/' . $conversation->id . '/messages') }}">
														<i class="icon-eye"></i> {{ ('Approve') }}
													</a>
												</p>
												<p>
													<a class="btn btn-danger btn-sm delete-action" style="width: 4rem;" href="{{ lurl('account/conversations/' . $conversation->id . '/delete') }}">
														<i class="fa fa-trash"></i> {{ t('Delete') }}
													</a>
												</p>
											</div>
