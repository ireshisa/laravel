							...
							<form name="listForm" method="POST" action="{{ lurl('account/'.$pagePath.'/delete') }}">
								...
								<table id="addManageTable" class="table table-striped table-bordered add-manage-table table demo" data-filter="#filter" data-filter-text-only="true">
									...
									<tr>
										...
										@endif
										<th style="width:88%" data-sort-ignore="true">{{ ('Notifications') }}</th>
									...
									<tr>
										...
										<td class="action-td">
											<div>
												<p class="text-center">
													<a class="btn btn-view btn-sm" style="width: 4rem;" href="{{ lurl('account/conversations/' . $conversation->id . '/messages') }}">
