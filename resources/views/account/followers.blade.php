                            ...
                            <table id="addManageTable" class="table table-striped table-bordered add-manage-table table demo" data-filter="#filter" data-filter-text-only="true">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width:88%" data-sort-ignore="true">{{ ('Followers') }}</th>
                                            <th style="width:10%">{{ t('Option') }}</th>
                                        @else
                                            <th style="width:2%" data-type="numeric" data-sort-initial="true"></th>
                                            <th style="width:88%" data-sort-ignore="true">Following Companies</th>
                                            <th style="width:10%">{{ t('Option') }}</th>
                                            @endif
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div style="word-break:break-all;">                                                        
                                                        <strong>{{ $company->follower->name }}</strong><br>
                                                        <strong>{{ t('Email') }}:</strong>&nbsp;{{(!empty($company->follower->email)?$company->follower->email:"Not Available")  }}<br>
                                                        <strong>{{ t('Phone') }}:</strong>&nbsp;{{(!empty($company->follower->phone)?$company->follower->phone:"Not Available") }}<br>
                                                    </div>
                                                </td>
                                                    <td class="action-td">
                                                        <div>
                                                            <p class="text-center">
                                                                <a class="btn btn-view btn-sm" href="{{ lurl('search-talent/seeker/' . $company->follower->id ) }}">
                                                                    <i class="icon-eye"></i> {{ t('View') }}
                                                                </a>
                                                            </p>
                                                        <!--                                                        <p>
                                                            <a class="btn btn-danger btn-sm delete-action" href="{{ lurl('account/conversations/' . $company->id . '/delete') }}">
                                                                <i class="fa fa-trash"></i> {{ t('Delete') }}
                                                                </a>
                                                            </p>-->
                                                        </div>
                                                    ...
                                                    <td class="action-td">
                                                        <div>
                                                            <p class="text-center">
                                                                <a class="btn btn-view btn-sm" href="{{ lurl('company-detail/' . $company->company->id ) }}" style="width: 7rem">
                                                                    <i class="icon-eye"></i> {{ t('View') }}
                                                                </a>
                                                            </p>
                                                        </div>
