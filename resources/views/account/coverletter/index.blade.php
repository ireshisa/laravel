...
@section('content')
	...
	<div class="col-md-9 page-content">
					<div class="inner-box">
						<h2 class="title-2"><i class="icon-town-hall"></i> {{ ('cover letter') }} </h2>
						<div class="mb30">
							<a href="{{ lurl('account/coverletter/create') }}" class="btn btn-default"><i class="icon-plus"></i> {{ ('Add a cover letter') }}</a>
						</div>
						<br>
					...
					<div class="inner-box">
						...
						<div class="col-lg-12">
							<form action="{{ lurl('account/resumes/skills') }}" method="POST" class="form">
								...
								<div class="form-group">
									<button type="submit" class="btn btn-primary">Save</button>
									<a href="{{route('resume.download')}}" target="_blank" class="btn btn-primary">Cover letter View & Download</a>
								</div>
							</form>
						</div>
					</div>
