		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-9 page-content">
					...
					<div class="inner-box">
						<h2 class="title-2"><i class="icon-attach"></i> {{ ('Add a new coverletter') }} </h2>
					
						<div class="mb30" style="float: right; padding-right: 5px;">
							<a href="{{ lurl('account/coverletter') }}">{{ ('cover letter') }}</a>
						</div>
						...
						<div class="panel-group" id="accordion">
							...
							<div class="card card-default">
								<div class="card-header">
									<h4 class="card-title"><a href="#resumePanel" data-toggle="collapse" data-parent="#accordion"> {{ ('cover letter') }} </a></h4>
								</div>
								<div class="panel-collapse collapse show" id="resumePanel">
									<div class="card-body">
										<form name="resume" class="form-horizontal" role="form" method="POST" action="{{ lurl('account/coverletter') }}" enctype="multipart/form-data">
											{!! csrf_field() !!}
