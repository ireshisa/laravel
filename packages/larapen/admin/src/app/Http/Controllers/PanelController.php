...
class PanelController extends Controller
{
	...
	public function removeStaffButtons()
    {
        $user = User::findOrFail(\auth()->user()->id);
//        $perm = $user->getAllPermissions();
//        $perm_list = $perm->filter(function ($value,$key) {
//            return $value->name="list-permission";
//        });
//        $user->g
        //dd($perm_list);
        if ($user->hasRole('staff') ) {
            ...
            $this->xPanel->removeColumn('action');
        }
    }
